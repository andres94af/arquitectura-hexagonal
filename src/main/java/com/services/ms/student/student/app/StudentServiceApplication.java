package com.services.ms.student.student.app;
...
public class StudentServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		List<StudentEntity> entities = Arrays.asList(
				...
				new StudentEntity(null, "Carlos", "Gabriel", 31, "Calle 2"),
				new StudentEntity(null, "Carmen", "Fernandez", 55, "Calle 3"),
				new StudentEntity(null, "Andres", "Clemente", 44, "Calle 4")
		);
